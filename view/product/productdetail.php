<?php
   ...
   $products=productrepos::readwithid($_GET["id_product"]);
   $productswithcategorie=productrepos::readwithcategorie($_GET["id_categorie"]);
?>   
                       ...
                       <div class="zoom_gallery_inner d-flex">
                           ...
                           <div class="product_zoom_main_img">
                                <div class="product_zoom_thumb">
                                    <img width="500px" data-image="../assets/img/product/big-product/product1.png" src="../assets/img/product/<?php echo $products[0]["image"];?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">
                       <form action="#">
                            ...
                            <div class="price_box">
                                <span class="current_price">$<?php echo $products[0]["prixpromo"];?></span>
                            </div>
                            ...
                            <div class="product_sku">
                                <p><span>SKU: </span> <?php echo $products[0]["sku"];?></p>
                            </div>
    ...
    <section class="product_area related_products mb-118">
        <div style="display:inline-block;padding:0% 2.5% 0% 2%;" class="container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="product_container row">
               ...
               <?php foreach($productswithcategorie as $productwithcategorie) { ?>

                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a href="product-details.html" >
                                        <img class="primary_img" src="../assets/img/product/<?php echo $productwithcategorie["image"];?>" alt="consectetur">
                                    </a>
                                ...
                                <figcaption class="product_content text-center">
                                    ...
                                    <h4 class="product_name"><a href="product-details.html"><?php echo $productwithcategorie["nom"];?></a></h4>
                                    <div class="price_box">
                                        <span class="current_price">$<?php echo $productwithcategorie["prixpromo"];?></span>
                                        <span class="old_price">$<?php echo $productwithcategorie["prixorg"];?></span>
                                    </div>
