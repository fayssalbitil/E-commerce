                    ...
                    <div class="col-12">
                        <div class="header_container d-flex justify-content-between align-items-center">
                            ...
                            <div class="header_logo">
                                <a class="sticky_none" href="./index.php"><img style="height:80px;height:80px;" src="../assets/img/logo/clothes.jpg" alt=""></a>
                            </div>
                            <!--main menu start-->
                            <div class="main_menu d-none d-lg-block">
                                <nav>
                                    <ul class="d-flex">
                                        <li><a class="active" href="/index.php/homepage">homepage</a></li>
                                        <li><a href="/index.php/shop">shop</a></li>
                                        <?php if($_SESSION["user_login"]!=null && $_SESSION["password"]!= null){
                                        ?>
                                        <li><a href="/index.php/dashbord.php">Dashbord</a></li>
                                        <?php }
                                            else{
                                        ?>
